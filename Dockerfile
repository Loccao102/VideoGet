...
ENV PYTHONUNBUFFERED=1 \
    ...
    KUAISHOU_NATIVE_SEARCH=true \
    KUAISHOU_NATIVE_SEARCH_TIMEOUT_SEC=35 \
    KUAISHOU_NATIVE_SEARCH_RENDER_MS=10000 \
    KUAISHOU_PAGE_TIMEOUT_SEC=35 \
    KUAISHOU_MEDIA_TIMEOUT_SEC=120 \
    BILIBILI_BIN=bili \
