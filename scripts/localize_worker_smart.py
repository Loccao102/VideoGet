#!/usr/bin/env python3
"""Persistent localization worker with contextual translation + smart rendering."""
import json
import os
...
# Keep the persistent Whisper/cache pipeline, but replace translation/TTS/render with
# Localization V2 context-aware implementations.
...
def contextual_translate_stage(
    ...
    if cached and cached.get("segments"):
        ...
        worker.base.log(f"Contextual translation cache hit: {len(translated)} segment")
