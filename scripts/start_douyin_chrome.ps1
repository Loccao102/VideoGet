...
Write-Host ""
Write-Host "If VideoGet runs directly on Windows:"
Write-Host "  DOUYIN_CDP_URL=http://127.0.0.1:$Port"
Write-Host ""
Write-Host "If VideoGet runs in Docker Desktop, try:"
Write-Host "  DOUYIN_CDP_URL=http://host.docker.internal:$Port"
Write-Host "If Docker cannot reach a loopback-bound DevTools port, rerun this script with a Docker-reachable bind address."
Write-Host ""
